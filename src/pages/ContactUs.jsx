...
export default function ContactUs() {
  return (
    <>
      <section className="bg-[#eef6ea] py-20 px-4 pt-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-5">
              ...
              {/* Office */}
              <div className="bg-white rounded-2xl p-5 border-0 shadow-md hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
              ...
              {/* Site Visit Card */}
              <div className="bg-green-700 text-white rounded-2xl p-6 shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
                <FiCalendar size={22} />
                ...
                <button className="mt-5 bg-white text-green-700 px-5 py-2 rounded-full font-medium hover:bg-gray-100 transition">
                  Schedule my visit
                </button>
              </div>
            ...
            {/* Right Side Form */}
            <div className="bg-white rounded-3xl p-8 border-0 shadow-lg hover:shadow-2xl transition-all duration-300">
              ...
              <form className="space-y-5">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl px-4 py-3 outline-none border border-gray-300 focus:border-green-600"
                    />
                  </div>
                ...
                <div>
                  ...
                  <select className="w-full rounded-xl px-4 py-3 outline-none border border-gray-300 focus:border-green-600">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl px-4 py-3 outline-none resize-none border border-gray-300 focus:border-green-600"
                  ></textarea>
                </div>
